...
Namespace i18n
    ...
    Public Class i18n
        ...
        '''<summary>
        '''  查找类似 Select a folder to compress 的本地化字符串。
        '''</summary>
        Public Shared ReadOnly Property Home_SelectFolderSysteam() As String
            Get
                Return ResourceManager.GetString("Home_SelectFolderSysteam", resourceCulture)
            End Get
        End Property
        ...
        '''<summary>
        '''  查找类似 An instance of CompactGUI is already running 的本地化字符串。
        '''</summary>
        Public Shared ReadOnly Property Message_RunTwoPrograms() As String
            Get
                Return ResourceManager.GetString("Message_RunTwoPrograms", resourceCulture)
            End Get
        End Property
        ...
        '''<summary>
        '''  查找类似 Quickly parses over files and estimates their compression ratio without writing to disk.
        '''This will likely be super laggy on HDDs! 的本地化字符串。
        '''</summary>
        Public Shared ReadOnly Property SetCompression_NonSteamFoldersTip() As String
            Get
                Return ResourceManager.GetString("SetCompression_NonSteamFoldersTip", resourceCulture)
            End Get
        End Property
